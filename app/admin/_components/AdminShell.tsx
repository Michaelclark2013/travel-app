...
const NAV: NavItem[] = [
  ...
  { href: "/admin/campaigns/push", label: "Push", perm: "support.broadcast" },
  { href: "/admin/campaigns/email", label: "Email", perm: "support.broadcast" },
  { href: "/admin/campaigns/banner", label: "Banner", perm: "support.broadcast" },
