...
// Lazy-require lib/social so this builds against `main` even before Track A's
// social layer is merged in. Once the integrated tree exists this resolves to
// the real `MOCK_USERS` export. See SEO_NOTES.md for the rationale.
type MockUserLite = { username: string };
